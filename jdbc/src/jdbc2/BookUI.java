...
public class BookUI {
  ...
  public void showMenu() {
    ...
    System.out.println("1. 전체 2. 상세조회 3. 등록 4. 수정 5. 삭제 0. 종료 ");
    System.out.println(
      "----------------------------------------------------------------------------------------"
    );
  ...
  private void 상세조회() throws SQLException {
    ...
    System.out.println("### 책번호를 입력해서 도서 상세 정보를 확인하세요.");
    ...
    System.out.print("저자: " + book.getWriter());
    System.out.print("가격: " + book.getPrice());
    System.out.print("수량: " + book.getStock());
    System.out.print("등록일: " + book.getRegDate());
    System.out.println(
      "--------------------------------------------------------------"
    );
  }
